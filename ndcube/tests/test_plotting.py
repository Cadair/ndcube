...
cube_none_axis_ranges_axis2 = [False, False, False, np.array([0.4, 0.8, 1.2, 1.6])]

cube_none_axis_ranges_axis2_s = copy.deepcopy(cube_none_axis_ranges_axis2)
cube_none_axis_ranges_axis2_s[3] = cube_none_axis_ranges_axis2[3] * 60.

cube_none_axis_ranges_axis2_bye = copy.deepcopy(cube_none_axis_ranges_axis2)
cube_none_axis_ranges_axis2_bye[3] = cube.extra_coords["bye"]["value"].value

cube_none_axis_ranges_axis2_array = copy.deepcopy(cube_none_axis_ranges_axis2)
cube_none_axis_ranges_axis2_array[3] = np.arange(0, cube.data.shape[-1])
...
@pytest.mark.parametrize("test_input, test_kwargs, expected_values", [
    ...
    (cube_unit, {"plot_axis_indices": -2, "axes_coordinates": "bye"},
     (cube_data_3, cube_none_axis_ranges_axis2_bye, "bye [m]", "Data [J]")),

    (cube, {"plot_axis_indices": -2, "axes_coordinates": np.arange(10, 10+cube.data.shape[-1])},
